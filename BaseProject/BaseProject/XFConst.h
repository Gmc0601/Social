...
UIKIT_EXTERN NSString *const XFMyCenterUrl;             // 个人中心
UIKIT_EXTERN NSString *const XFMyAliPayBackUrl;         // 支付宝回调
UIKIT_EXTERN NSString *const XFMyAllbumDeleteUrl;       // 我的相册删除
UIKIT_EXTERN NSString *const XFMyAllbumUploadUrl;       // 我的相册上传
